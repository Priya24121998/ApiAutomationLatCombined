...
Feature: B2C NZ Get API Scenarios

  @sapecomm-9783 @B2C_NZ_Get
  Scenario: [GDC-12907] Revisit/Research Bundle Stock logic (K vs. A stock type) - Bundle Scenario check for B2C NZ Store
