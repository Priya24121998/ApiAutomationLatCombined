Feature: B2B GT SOP  Scenarios
  ...
  Scenario: [GDC-12829] [Thorndike] Verify that API should return the '400' status code in the SOP response API response with an error message if gets an error in CyberSource.
   ...
   #------------------------------------Removed  code------------------------------
    #
    #@B2BGT_SOP
  #Scenario: [GDC-12823] [Using GALE user] Verify that the API should return the 400 status code in the SOP response API response with an error message if skipping the CyberSource details.
    #Given I Hit Api to create B2BGT Token
    #When I hit API to create B2BGT cart
      #| basestore | cengage-b2b-gt |
      #| status    |            201 |
    ...
    #And Test Data for GDC-12823 and Cart details
#
  #@B2BGT_SOP
  #Scenario: [GDC-12825] [Using Thorndike User] Verify that the API should return the 400 status code in the SOP response API response with an error message if skipping the CyberSource details.
    #Given I Hit Api to create B2BThorndike Token
    #When I hit API to create B2BThorndike cart
      #| basestore | cengage-b2b-gt |
      #| status    |            201 |
