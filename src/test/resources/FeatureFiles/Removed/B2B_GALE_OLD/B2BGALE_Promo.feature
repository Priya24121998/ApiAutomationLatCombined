Feature: B2B GT Promo Code Scenarios
  ...
  #################################################  Smoke   ################################################################
  #
  #Scenario: [GDC-10393] Verify that user is able to place an order using PO + Promo code.
  ...
  #Then I verify total amount is 83.6
  ...
  #| basestore | cengage-b2b-gt |
  #| status    |            200 |
  #And I verify totalDiscounts amount is 25.08
  #Then I verify total amount is 58.52
