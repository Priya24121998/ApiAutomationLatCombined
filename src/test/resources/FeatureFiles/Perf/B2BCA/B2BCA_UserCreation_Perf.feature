...
#--------------------------------------------------------PERF---------------------------------------------------------------------------------------------------------#
  ...
  @B2B_CA_User_Creation_iteration_Perf
  ...
  @B2B_CA_User_Creation_Multiple_Perf
  ...
  @B2B_CA_User_Creation_Multiple_Perf_RunTime
  Scenario: Creating B2B US multiple users
    Given I Hit Api to create B2BCANew Token
    And I have to create and activate n number b2b canada users at run time for perf environment and to activate it and log the results password for user creation for the test case UserCreation
      | basestore | cengage-b2b-ca |
      | store     | B2BCA          |
      | email     | automation     |
      | status    |            201 |
