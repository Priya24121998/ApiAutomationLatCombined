Feature: B2B US user creation
 #################################################  Smoke and Regression  ###########################################################
  ...
  @B2B_US_User_Creation_iteration_Perf
  Scenario: Creating B2B US users
    Given I Hit Api to create B2BUSNew Token
  ...
  @B2B_US_User_Creation_Multiple_Perf
  ...
  @B2B_US_User_Creation_Multiple_Perf_RunTime
  Scenario: Creating B2B US multiple users
    Given I Hit Api to create B2BUSNew Token
    And I have to create and activate n number b2b us users at run time for perf environment and to activate it and log the results password for user creation for the test case UserCreation
      | basestore | cengage-b2b-us |
      | store     | B2BUS          |
      | email     | automation     |
      | status    |            201 |
